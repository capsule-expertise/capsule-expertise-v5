          ...
          {O.packs.map((p, i) => (
            <motion.article
              ...
              className={cn(
                ...
                p.highlighted
                  ? // Center card : slightly bigger padding, brighter bg, gold accent
            ...
            >
              ...
              <div
                className={cn(
                  'flex flex-col flex-1 gap-7',
                  p.highlighted ? 'p-9 md:p-12' : 'p-9 md:p-10',
                )}
              >
                {/* Badge "Le plus choisi" sur card highlighted */}
                {p.highlighted && p.badge && (
                  <div
                    className="inline-flex items-center gap-2 self-start text-[11px] font-medium tracking-[0.16em] uppercase text-[var(--color-ce-terra-deep)]"
                  >
                    <span
                      aria-hidden
                ...
                {/* Footer text — italique discret */}
                <p className="text-[13px] italic leading-[1.55] text-[rgba(20,37,58,0.55)] pt-2 border-t border-[rgba(20,37,58,0.06)]">
                  {p.footer}
                </p>
